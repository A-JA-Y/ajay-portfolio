    ...
    <>
      <div className="about w-full bg-slate-300 dark:bg-zinc-800 dark:text-white rounded-md font-mono py-6 px-4">
        ...
        <div className="container mx-auto flex flex-col lg:flex-row  items-center justify-center pb-3">
          ...
          <div className="links my-4 w-full lg:w-auto">
            <div className="icons flex flex-row lg:flex-col justify-center items-center">
              <a
          ...
          <div className="right w-full lg:w-2/5 p-4">
            <div className="skills flex flex-col items-center justify-center right-animation">
              ...
              <ul className="text-base sm:text-2xl font-semibold">
                <li>
                  <div className="flex items-center justify-center hover:scale-105">
                    <FaHtml5 className="mx-1 hover:text-yellow-600" />
                    <span className="hover:text-yellow-500 hover:scale-105 transition-all">
                      HTML
                    </span>
                  </div>
                </li>
                <li>
                  <div className="flex items-center justify-center hover:scale-105">
                    <FaCss3Alt className="mx-1 hover:text-blue-700" />
                    <span className="hover:text-yellow-500 hover:scale-105 transition-all">
                      CSS
                    </span>
                  </div>
                ...
                <li>
                  <div className="flex items-center justify-center hover:scale-105">
                    <IoLogoJavascript className="mx-1 hover:text-yellow-400" />
                    <span className="hover:text-yellow-500 hover:scale-105 transition-all">
                      Javascript
                    </span>
                  </div>
                ...
                <li>
                  <div className="flex items-center justify-center hover:scale-105">
                    <FaReact className="mx-1 hover:text-blue-600" />
                    <span className="hover:text-yellow-500 hover:scale-105 transition-all">
                      React Js
                    </span>
                  </div>
                ...
                <li>
                  <div className="flex items-center justify-center hover:scale-105">
                    <RiTailwindCssFill className="hover:text-cyan-400 mx-1" />
                    <span className="hover:text-yellow-500 hover:scale-105 transition-all">
                      Tailwind CSS
                    </span>
                  </div>
